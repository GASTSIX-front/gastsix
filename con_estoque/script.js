...
function mostrarMenu (){
    if (window.getComputedStyle(document.getElementById("menu_lateral")).display == "none") {
        document.getElementById("menu_lateral").style.display = "flex"
...
function mostrar_menu_cadastro (){
    if (window.getComputedStyle(document.getElementById("menu_lateral_cadastro")).display == "none") {
        document.getElementById("menu_lateral_cadastro").style.display = "flex"
